  ...
  return (
    <div className='header'>
      ...
      <div>
        ...
        <select className='header-sort_select' value={sortValue} onChange={(event) => onChangeHandler(event)}>
        ...
        <input type='checkbox' checked={areAllTodosCompleted} onChange={() => onToggleAll(areAllTodosCompleted)} />
      </div>
    </div>
  );
};
